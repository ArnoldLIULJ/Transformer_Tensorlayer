...
def define_compute_bleu_flags():
  ...
  flags.DEFINE_string(
      name="reference", default="./data/data/newstest2013.de", help=None)

  flags.DEFINE_enum(
      name="bleu_variant", short_name="bv", default="both",
      enum_values=["both", "uncased", "cased"], case_sensitive=False, help=None)
